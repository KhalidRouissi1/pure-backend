    ...
    <View style={styles.root}>
      ...
      <FlatList
        ...
        contentContainerStyle={[
          cart.items.length ? styles.list : styles.emptyList,
...
const styles = StyleSheet.create({
  ...
  list: { paddingVertical: 16, paddingBottom: 180 },
