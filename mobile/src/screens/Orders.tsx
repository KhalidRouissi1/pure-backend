    ...
    <View style={styles.root}>
      ...
      <FlatList
        ...
        contentContainerStyle={[
          orders.length ? styles.list : styles.emptyList,
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <Text style={styles.cardText}>
              {item.status} · {t('sar')} {item.total}
            </Text>
            <Text style={styles.cardText}>
              {t('eta_minutes', { minutes: item.deliveryEtaMinutes })}
            </Text>
          </TouchableOpacity>
        )}
      />
...
export function OrderDetail({ route }: any) {
  ...
  return (
    <View style={styles.root}>
      <View style={[styles.detailHeader, { paddingHorizontal: layout.outerInset + layout.gutter }]}>
      ...
      <FlatList
        ...
        ListFooterComponent={
          <Text style={styles.total}>
            {t('total_price', { currency: t('sar'), total: order.total })}
          </Text>
        }
      />
    </View>
